...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('inventory_out', function (Blueprint $table) {
            ...
            $table->date('trans_date')->nullable()->index('trans_date');
            $table->integer('out_from')->nullable()->default(0)->index('out_from');
            $table->integer('in_to')->nullable()->default(0)->index('in_to');

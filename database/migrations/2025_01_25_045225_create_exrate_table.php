...
return new class extends Migration
{
    ...
    {
        Schema::create('exrate', function (Blueprint $table) {
            $table->increments('row_id');
            $table->integer('company_id')->index('company_id');
            $table->decimal('rate_beli', 10)->nullable()->default(0);
            $table->decimal('rate_jual', 10)->nullable();
            $table->decimal('profit_margin', 10)->nullable();
            $table->decimal('gold_price', 10)->nullable();

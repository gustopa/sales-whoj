...
return new class extends Migration
{
    ...
    {
        Schema::create('production_diamond', function (Blueprint $table) {
            ...
            $table->integer('diamond_type_id')->nullable()->default(0)->index('diamond_type_id');
            $table->integer('pcs')->nullable()->default(0);
            $table->decimal('crt', 15, 3)->nullable()->default(0);
            $table->dateTime('delivery_date')->nullable();
            $table->dateTime('received_date')->nullable();
            $table->integer('remaining_pcs')->nullable()->default(0);
            $table->decimal('remaining_crt', 15, 3)->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('production_diamond');
    }
};

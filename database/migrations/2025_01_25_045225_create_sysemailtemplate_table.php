...
return new class extends Migration
{
    ...
    {
        Schema::create('sysemailtemplate', function (Blueprint $table) {
            $table->increments('row_id');
            $table->integer('company_id')->index('company_id');
            $table->string('content_for', 100)->nullable();
            $table->string('email_subject', 100)->nullable();
            $table->string('email_txt', 4000)->nullable();
    ...
    {
        Schema::dropIfExists('sysemailtemplate');
    }
};

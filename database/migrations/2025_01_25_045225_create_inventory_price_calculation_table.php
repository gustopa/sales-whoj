...
return new class extends Migration
{
    ...
    {
        Schema::create('inventory_price_calculation', function (Blueprint $table) {
            ...
            $table->decimal('production_cost', 10)->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('inventory_price_calculation');
    }
};

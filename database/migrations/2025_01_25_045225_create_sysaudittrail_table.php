...
return new class extends Migration
{
    ...
    {
        Schema::create('sysaudittrail', function (Blueprint $table) {
            $table->increments('row_id');
            $table->integer('company_id')->index('company_id');
            $table->string('module_name', 100)->nullable();
            $table->string('module_action', 100)->nullable();
            $table->string('module_query', 4000)->nullable();
    ...
    {
        Schema::dropIfExists('sysaudittrail');
    }
};

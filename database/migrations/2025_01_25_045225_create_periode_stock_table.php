...
return new class extends Migration
{
    ...
    {
        Schema::create('periode_stock', function (Blueprint $table) {
            $table->increments('row_id');
            $table->integer('company_id')->index('company_id');
            $table->string('periode', 100)->nullable();
            $table->string('periode_month', 100)->nullable();
            $table->integer('periode_year')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('periode_stock');
    }
};

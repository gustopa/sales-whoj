...
function FormProductName({title,sxButton,iconButton,endpoint,nama,table}) {
    ...
    const handleSubmit = async () => {
        try{
            ...
            showAlert("Berhasil!",`Nama berhasil di${title.toLowerCase()}`, "success")
  ...
  return (
    <LayoutModal ref={modalTambah} height='auto' closeButton={false} width={ isMobile ? "80%" : "30%"} sxButton={sxButton} iconButton={iconButton}>
        <h2 className='text-1xl font-bold mb-4 text-center'>{title} NAMA PRODUK</h2>

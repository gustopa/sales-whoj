...
function FormPosition({title,sxButton,iconButton,endpoint,nama,table}) {
    ...
    const handleSubmit = async () => {
        try{
            ...
            showAlert("Berhasil!",`Model berhasil di${title.toLowerCase()}`, "success")
  ...
  return (
    <LayoutModal ref={modalTambah} height='auto' closeButton={false} width={ isMobile ? "80%" : "30%"} sxButton={sxButton} iconButton={iconButton}>
        ...
        <Input defaultValue={nama} onChange={e => setData(e.target.value)} fullWidth label="Letak barang"/>
        <div className='mt-3'>
